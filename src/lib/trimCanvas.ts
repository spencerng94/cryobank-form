...
function scanY(fromTop: boolean, imgWidth: number, imgHeight: number, imgData: Uint8ClampedArray) {
...
function scanX(fromLeft: boolean, imgWidth: number, imgHeight: number, imgData: Uint8ClampedArray) {
